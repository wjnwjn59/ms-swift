# Training script for InternVL3_5-8B with NarrativeInfoVQA dataset
# 2 * 23GiB; 2.3s/it
...
megatron sft \
--model /media/workspace/thangdd_workspace/llm_checkpoints/OpenGVLab_InternVL3_5-8B \
...
--max_epochs 1 \
--save megatron_output/InternVL3_5-8B-NarrativeInfoVQA \
--save_interval 3000 \
...
--wandb_exp_name InternVL3_5-8B-NarrativeInfoVQA_1e_fullset \
